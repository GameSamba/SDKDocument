...
1. gamesamba-analytics-sdk-3.3.8.aar（GameSamba 统计SDK）
...
dependencies {
    ...
    // 统计功能SDK (必需)
    compile(name: 'gamesamba-analytics-sdk-3.3.8', ext: 'aar')
    // Appsflyer模块
...
dependencies {
    ...
    // 统计功能SDK (必需)
    implementation(name: 'gamesamba-analytics-sdk-3.3.8', ext: 'aar')
    // Appsflyer模块
